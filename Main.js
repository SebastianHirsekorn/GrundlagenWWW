...
var $author$project$Main$GotFoodData = function (a) {
	return {$: 'GotFoodData', a: a};
};
var $author$project$Main$GotFoods = function (a) {
	return {$: 'GotFoods', a: a};
};
...
var $author$project$Main$Nutrient = F2(
	function (name, amount) {
		return {amount: amount, name: name};
	});
var $elm$json$Json$Decode$float = _Json_decodeFloat;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$nutrientDecoder = function (nutrientType) {
	return A3(
		$elm$json$Json$Decode$map2,
		$author$project$Main$Nutrient,
		A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
		A2($elm$json$Json$Decode$field, 'amount', $elm$json$Json$Decode$float));
};
var $author$project$Main$checkNutrientDecoder = A2(
	$elm$json$Json$Decode$andThen,
	$author$project$Main$nutrientDecoder,
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string));
var $author$project$Main$Food = F5(
	function (name, id, img, amount, nutrition) {
		return {amount: amount, id: id, img: img, name: name, nutrition: nutrition};
	});
var $author$project$Main$foodConverter = F5(
	function (name, id, image, amount, nutrientList) {
		var nutrition = A3(
			$elm$core$List$foldl,
			F2(
				function (a, b) {
			...
			{carbs: 0.0, fat: 0.0, kcal: 0.0, protein: 0.0},
			nutrientList);
		return A5($author$project$Main$Food, name, id, image, amount, nutrition);
	});
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $elm$json$Json$Decode$list = _Json_decodeList;
var $elm$json$Json$Decode$map5 = _Json_map5;
var $author$project$Main$foodDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Main$foodConverter,
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	...
	A2(
		...
		A2(
			$elm$json$Json$Decode$field,
			'nutrients',
			$elm$json$Json$Decode$list($author$project$Main$checkNutrientDecoder))));
...
var $author$project$Main$HTTPSearchResults = F4(
	function (results, offset, number, totalResults) {
		return {number: number, offset: offset, results: results, totalResults: totalResults};
	});
var $author$project$Main$Ingredient = F3(
	function (name, id, img) {
		return {id: id, img: img, name: name};
	});
var $elm$json$Json$Decode$map3 = _Json_map3;
var $author$project$Main$ingredientDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Main$Ingredient,
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'image', $elm$json$Json$Decode$string));
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$Main$resultDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Main$HTTPSearchResults,
	A2(
		$elm$json$Json$Decode$field,
		'results',
		$elm$json$Json$Decode$list($author$project$Main$ingredientDecoder)),
	...
	function (foodMsg, model) {
		switch (foodMsg.$) {
			case 'DeleteFood':
				...
				return ($elm$core$List$length(model.foods) === 1) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							currNutrition: {carbs: 0.001, fat: 0.001, kcal: 0.001, protein: 0.001},
					...
					$elm$http$Http$request(
						{
							...
							expect: A2($elm$http$Http$expectJson, $author$project$Main$GotFoods, $author$project$Main$resultDecoder),
							headers: _List_Nil,
							method: 'GET',
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'OpenModal':
				var modalMsg = msg.a;
				return A2($author$project$Main$updateModal, modalMsg, model);
			case 'CloseModal':
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'ChangeFoods':
				var foodMsg = msg.a;
				return A2($author$project$Main$updateFood, foodMsg, model);
			case 'GotFoods':
				var httpResponse = msg.a;
				if (httpResponse.$ === 'Ok') {
					var result = httpResponse.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{errorMsg: 'Liste wird nicht abgeholt'}),
						$elm$core$Platform$Cmd$none);
				}
			case 'GotFoodData':
				var httpResponse = msg.a;
				if (httpResponse.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{errorMsg: 'Informationen werden nicht abgeholt'}),
						$elm$core$Platform$Cmd$none);
				}
			case 'Input':
				var inputType = msg.a;
			...
			default:
				var key = msg.a;
				return (key === 13) ? A2(
					$author$project$Main$updateFood,
					$author$project$Main$GetFoods(model.searchTerm),
...
var $author$project$Main$foodToListTable = F2(
	function (foods, tableType) {
		if (tableType.$ === 'FoodsList') {
			return A2(
				$elm$core$List$indexedMap,
				F2(
					function (i, food) {
						return A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('table-row-hover-background-color'),
											...
											_List_fromArray(
												[
													...
													$author$project$Main$ChangeFoods(
														$author$project$Main$DeleteFood(i)))
												]),
											_List_fromArray(
												[
			...
			[
				...
				_List_fromArray(
					[
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('thead')
											]),
										_List_fromArray(
											[
						...
						$elm$html$Html$tbody,
						_List_Nil,
						A2($author$project$Main$foodToListTable, model.foods, $author$project$Main$FoodsList))
					]))
			]));
};
...
var $author$project$Main$showFoodModal = function (food) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$modalHeader(food.name),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('tile is-6')
									]),
								_List_fromArray(
									[
										A2(
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class('tile is-child image is-128x128')
															]),
														_List_fromArray(
															[
																A2(
																...
																_List_fromArray(
																	[
																		$elm$html$Html$Attributes$src('https://spoonacular.com/cdn/ingredients_100x100/' + food.img)
																	]),
																_List_Nil)
															])),
														A2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_Nil),
					function () {
					var food = modalState.a;
					return $author$project$Main$showFoodModal(food);
				}()
				]));
	}
};
...
var $author$project$Main$pageContent = function (model) {
	...
	switch (_v0.$) {
		case 'Home':
			var nS = model.settings.nutritionSettings;
			var protein = (A2(
				$elm$core$Maybe$withDefault,
				2000,
				$elm$core$String$toFloat(nS.kcalGoal)) / 4.0) * (A2(
				$elm$core$Maybe$withDefault,
				30,
				$elm$core$String$toFloat(nS.proteinSplit)) / 100);
			var fat = (A2(
				$elm$core$Maybe$withDefault,
				2000,
				$elm$core$String$toFloat(nS.kcalGoal)) / 9.0) * (A2(
				$elm$core$Maybe$withDefault,
				30,
				$elm$core$String$toFloat(nS.fatSplit)) / 100);
			var carbs = (A2(
				$elm$core$Maybe$withDefault,
				2000,
				$elm$core$String$toFloat(nS.kcalGoal)) / 4.0) * (A2(
				$elm$core$Maybe$withDefault,
				30,
				$elm$core$String$toFloat(nS.carbsSplit)) / 100);
			return A2(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text(
														A2($myrho$elm_round$Round$round, 2, model.currNutrition.kcal) + ' kcal')
													]))
											]))
									])),
								A2(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text(
														A2($myrho$elm_round$Round$round, 2, model.currNutrition.fat) + ' g')
													]))
											]))
									])),
								A2(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text(
														A2($myrho$elm_round$Round$round, 2, model.currNutrition.carbs) + ' g')
													]))
											]))
									])),
								A2(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text(
														A2($myrho$elm_round$Round$round, 2, model.currNutrition.protein) + ' g')
													]))
											]))
									]))
							])),
										...
										_List_fromArray(
											[
												...
												A2(
													$elm$core$Maybe$withDefault,
													2000,
													$elm$core$String$toFloat(nS.kcalGoal))) < 1) ? A3(
													...
													[
														...
														'noch ' + (A2(
															...
															A2(
																$elm$core$Maybe$withDefault,
																2000,
																$elm$core$String$toFloat(nS.kcalGoal)) - model.currNutrition.kcal) + ' kcal'),
														model.currNutrition.kcal),
														_Utils_Tuple2(
														'',
														A2(
															$elm$core$Maybe$withDefault,
															2000,
															$elm$core$String$toFloat(nS.kcalGoal)) - model.currNutrition.kcal)
													]),
												...
												_List_fromArray(
													[
														...
														A2(
															$myrho$elm_round$Round$round,
															2,
															model.currNutrition.kcal - A2(
																$elm$core$Maybe$withDefault,
																2000,
																$elm$core$String$toFloat(nS.kcalGoal))) + ' kcal zu viel',
														model.currNutrition.kcal - A2(
															$elm$core$Maybe$withDefault,
															2000,
															$elm$core$String$toFloat(nS.kcalGoal))),
														_Utils_Tuple2(
														'',
														(A2(
															$elm$core$Maybe$withDefault,
															4000,
															$elm$core$String$toFloat(nS.kcalGoal)) * 2.0) - model.currNutrition.kcal)
													]),
												{corner: 10, innerRadius: 80, position: 0},
												$elm$core$Array$fromList(
													_List_fromArray(
									...
									[
										...
										_List_fromArray(
											[
													...
													[
														...
														_List_fromArray(
															[
																...
																(_Utils_cmp(model.currNutrition.fat, fat) < 1) ? A2(
																$elm$html$Html$span,
																_List_fromArray(
																	[
																		$elm$html$Html$Attributes$class('tag'),
																...
																_List_fromArray(
																	[
																		$elm$html$Html$text(
																		'noch ' + (A2($myrho$elm_round$Round$round, 2, fat - model.currNutrition.fat) + ' g'))
																	])) : A2(
																$elm$html$Html$span,
																_List_fromArray(
																	[
																...
																_List_fromArray(
																	[
																		$elm$html$Html$text(
																		A2($myrho$elm_round$Round$round, 2, model.currNutrition.fat - fat) + ' g zu viel')
																	]))
															]))
													])),
												A2(
												...
												_List_fromArray(
													[
														(_Utils_cmp(model.currNutrition.fat, fat) < 1) ? A3(
														$author$project$Main$foodChart,
														_List_fromArray(
															[
																_Utils_Tuple2('', model.currNutrition.fat),
																_Utils_Tuple2('', fat - model.currNutrition.fat)
															]),
														...
														_List_fromArray(
															[
																_Utils_Tuple2('', model.currNutrition.fat - fat),
																_Utils_Tuple2('', (fat * 2.0) - model.currNutrition.fat)
															]),
														{corner: 10, innerRadius: 60, position: 0},
														$elm$core$Array$fromList(
															_List_fromArray(
										...
										_List_fromArray(
											[
													...
													[
														...
														_List_fromArray(
															[
																...
																(_Utils_cmp(model.currNutrition.carbs, carbs) < 1) ? A2(
																$elm$html$Html$span,
																_List_fromArray(
																	[
																		$elm$html$Html$Attributes$class('tag'),
																...
																_List_fromArray(
																	[
																		$elm$html$Html$text(
																		'noch ' + (A2($myrho$elm_round$Round$round, 2, carbs - model.currNutrition.carbs) + ' g'))
																	])) : A2(
																$elm$html$Html$span,
																_List_fromArray(
																	[
																...
																_List_fromArray(
																	[
																		$elm$html$Html$text(
																		A2($myrho$elm_round$Round$round, 2, model.currNutrition.carbs - carbs) + ' g zu viel')
																	]))
															]))
													])),
												A2(
												...
												_List_fromArray(
													[
														(_Utils_cmp(model.currNutrition.carbs, carbs) < 1) ? A3(
														$author$project$Main$foodChart,
														_List_fromArray(
															[
																_Utils_Tuple2('', model.currNutrition.carbs),
																_Utils_Tuple2('', carbs - model.currNutrition.carbs)
															]),
														{corner: 10, innerRadius: 60, position: 0},
														$elm$core$Array$fromList(
															_List_fromArray(
														...
														_List_fromArray(
															[
																_Utils_Tuple2('', model.currNutrition.carbs - carbs),
																_Utils_Tuple2('', (carbs * 2.0) - model.currNutrition.carbs)
															]),
														{corner: 10, innerRadius: 60, position: 0},
														$elm$core$Array$fromList(
															_List_fromArray(
										...
										_List_fromArray(
											[
													...
													[
														...
														_List_fromArray(
															[
																...
																(_Utils_cmp(model.currNutrition.protein, protein) < 1) ? A2(
																$elm$html$Html$span,
																_List_fromArray(
																	[
																		$elm$html$Html$Attributes$class('tag'),
																...
																_List_fromArray(
																	[
																		$elm$html$Html$text(
																		'noch ' + (A2($myrho$elm_round$Round$round, 2, protein - model.currNutrition.protein) + ' g'))
																	])) : A2(
																$elm$html$Html$span,
																_List_fromArray(
																	[
																...
																_List_fromArray(
																	[
																		$elm$html$Html$text(
																		A2($myrho$elm_round$Round$round, 2, model.currNutrition.protein - protein) + ' g zu viel')
																	]))
															]))
													])),
												A2(
												...
												_List_fromArray(
													[
														(_Utils_cmp(model.currNutrition.protein, protein) < 1) ? A3(
														$author$project$Main$foodChart,
														_List_fromArray(
															[
																_Utils_Tuple2('', model.currNutrition.protein),
														...
														_List_fromArray(
															[
																_Utils_Tuple2('', model.currNutrition.protein - protein),
																_Utils_Tuple2('', (protein * 2.0) - model.currNutrition.protein)
															]),
														{corner: 10, innerRadius: 60, position: 0},
														$elm$core$Array$fromList(
															_List_fromArray(
